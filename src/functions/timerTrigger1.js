...
app.timer('timerTrigger1', {
    ...
    handler: (myTimer, context) => {
        ...
        const url='https://eastus2.azure.data.mongodb-api.com/app/data-eetjq/endpoint/data/v1/action/insertOne';
        ...
        Http.send(JSON.stringify({"players": players, "timesteps": timesteps}));
